...
if __name__ == '__main__':
    ...
    #print  compPlayHand({'a': 2, 'c': 1, 'b': 1, 't': 1}, wordList, 5)
    #print compPlayHand({'a': 2, 'e': 2, 'i': 2, 'm': 2, 'n': 2, 't': 2}, wordList, 12)
    #print compPlayHand({'a': 1, 'p': 2, 's': 1, 'e': 1, 'l': 1}, wordList, 8)
    #print compPlayHand({'b': 1, 'i': 2, 'k': 1, 'j': 1, 'o': 1, 'w': 2}, wordList, 8)
    #print compPlayHand({'a': 1, 'k': 2, 'o': 1, 'p': 1, 't': 1, 'v': 1, 'z': 1}, wordList, 8)
